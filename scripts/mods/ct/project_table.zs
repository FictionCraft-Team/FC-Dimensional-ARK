...
var research = ResearchTable.addCategory(<contenttweaker:blueprint_advweapon>);
...
ResearchTable.builder("mk1_heat_absorber", cat)
  ...
  .setRewardCommands("/researchtable @p mk1_heat_absorber 0")
  .setRewardCommands("/researchtable @p mk2_heat_absorber 0")
  .setRewardCommands("/researchtable @p mk1_data 0")
  .setRewardCommands("/researchtable @p mk2_data 0")
  .setRewardCommands("/researchtable @p mk3_data 0")
